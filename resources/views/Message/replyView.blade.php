                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-danger" role="alert">
                              ...
                              @endif
                         <form action="/messagerie/reply/send" method="POST">
                            @csrf
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Vers </label>
                                <div class="col-sm-12 col-md-7"><input type="text" name="Sender" placeholder="" value="Boudhraad@gmail.com" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sujet</label>
                                <div class="col-sm-12 col-md-7"><input type="text" name="Sujet" value="{{$sujet}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
