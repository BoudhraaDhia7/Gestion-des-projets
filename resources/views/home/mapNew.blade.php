                                ...
                                <div class="nav-collapse collapse">
                                    <ul id="toolbar3_l" class="nav">
                                        <li><ul id="mainmenu" class="nav">
                                            ...
                                            <li class="{{ Request::route()->getName() == 'newProject' ? ' active' : ''}}"><a href="{{route("map")}}">Projets</a></li>
            ...
            <div id="top-content" class="span9">
                ...
                <div class="twpara-row row-fluid">
                    <div id="B0dqW6E1" class="span12 tw-para ">
                        <p class="projettext welcomep">Suivez les derniers progrès des Nouveaux projets :</p>
                    </div>
                </div>
                <div class="twpara-row row-fluid">
