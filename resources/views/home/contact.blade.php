...
<div id="content" class="container-fluid">
    ...
    <p style="color:red;margin-top:30px">*Vous voulez entrer un numéro telephonique valide. </p>
    <p style="color:red;margin-top:30px">*Vous recevrez un code de vérification, vous devez le saisir</p>
                <div class="twpara-row row-fluid">
                    <form style="margin-top:15px" action="/messagerie/user/store" method="get">
                        @csrf
                        <div class="form-group row mb-4 " style="margin-left: 0">
                            <label class="col-form-label text-md-right col-12 col-md-1 col-lg-12 ">Email :</label>
                            <div class="col-sm-12 col-md-12 m-0"><input type="text"  id="{{$errors->has('Sender') ?  'is-invalid':''}}" name="Sender" placeholder="" class="form-control" style="width: 99%">
                        ...
                        <div class="form-group row mb-4 " style="margin-left: 0">
                            <label class="col-form-label text-md-right col-12 col-md-1 col-lg-12 ">Numéro telephonique :</label>
                            <div class="col-sm-12 col-md-12 m-0"><input type="text"  id="{{$errors->has('Number') ?  'is-invalid':''}}" name="Number" placeholder="" class="form-control" style="width: 99%">
                                @if($errors->has('Number'))
                                <small id="text-danger" style="color: red">{{$errors->first('Number')}}</small>
                              @endif
                            </div>
                        </div>
                        <div class="form-group row mb-4" style="margin-left: 0">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sujet :</label>
                            <div class="col-sm-12 col-md-7"><input id="{{$errors->has('Sujet') ?  'is-invalid':''}}" type="text" name="Sujet" placeholder="" class="form-control"style="width: 99%">
                                @if($errors->has('Sujet'))
                                <small id="text-danger" style="color: red">{{$errors->first('Sender')}}</small>
                              @endif
                            </div>
                        ...
                        <div class="col-sm-12 col-md-7"><textarea id="{{$errors->has('Sujet') ?  'is-invalid':''}}" style="height: 400px;width: 99%" name="Msg" class="form-control" id="exampleFormControlTextarea1" rows="9"></textarea>
                            @if($errors->has('Msg'))
                                <small id="text-danger" style="color: red">{{$errors->first('Sender')}}</small>
                              @endif
                        </div>
