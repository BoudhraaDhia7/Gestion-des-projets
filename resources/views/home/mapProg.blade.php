                                ...
                                <div class="nav-collapse collapse">
                                    <ul id="toolbar3_l" class="nav">
                                        <li><ul id="mainmenu" class="nav">
                                            ...
                                            <li class="{{ Request::route()->getName() == 'progresedProject' ? ' active' : ''}}"><a href="{{route("map")}}">Projets</a></li>
            ...
            <div id="top-content" class="span9">
                ...
                <div class="twpara-row row-fluid">
                    <div id="B0dqW6E1" class="span12 tw-para ">
                        <div class="ptext">
                            <p class="projettext welcomep">Suivez les derniers progrès des projet en cours :</p>
                        </div>
                    </div>
                </div>
                <div class="twpara-row row-fluid">
...
</p></div></div></div></div><div id="top-sb" class="span3"><div id="2iZQVfNK" class="tw-para "><h2 class="Rounded-bordred" style="text-align:center" ><p>Nos projets</p></h2><div class="ptext">
...
<iframe scrolling="no" class="sn" frameborder="0" allowtransparency="true" title="Sondages Pixule"  height="365" src="//www.pixule.com/widget454953654196" data-key="454953654196"></iframe>
