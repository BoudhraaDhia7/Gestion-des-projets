...
<li><a href="{{route("Apropo")}}">Présentation</a></li>
    ...
    <div id="topic" class="row-fluid">
        <div id="topic-inner">
            <div id="top-content" class="span9">
                <div style="border-bottom: 2px solid #ef6536;"><P class="welcomep">Bienvenue sur notre site projet Kairouan</P></div>
                <div class="twpara-row row-fluid">
                    <div id="B0dqW6E1" class="span12 tw-para ">
                        <div class="ptext">
                            <div><p class="welcomTx">Projet kairouan est le site officiel de gouvernorat Kairouan, où vous pourrez échanger et visualiser tous les projets de l'Etat de Kairouan et sa banlieue .</p></div>
                        </div>
                    </div>
                </div>
                <div class="twpara-row row-fluid">
            ...
            <div class="twpara-row row-fluid">
                <div id="Q6OIaz1K" class="span12 tw-para ">
                    <h2 class="Rounded-bordred" style="text-align:center" ><p>Nous Suivre</p></h2><div class="ptext"><p>
...
<iframe class="sn"  scrolling="no" frameborder="0" allowtransparency="true" title="Sondages Pixule" width="220" height="365" src="//www.pixule.com/widget454953654196" data-key="454953654196"></iframe>
