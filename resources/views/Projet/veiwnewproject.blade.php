            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Affecter les ordre de travail ({{count($data)}})</h4>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" style="height: 60px;weight: 208px;">
                                            ...
                                            <a href="/home/projet/{{$item->id}}/orderaffect"><button class="btn btn-warning"style="height: 40px;weight: 40px;" ><i class="fas fa-arrow-right"></i></button></a>
