...
<section class="section">
    <div class="section-header">
      <h1>{{Auth::user()->name=='Admin'?"Projets en cours ":"Confirmer les achievement de travail"}}</h1>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{Auth::user()->name=='Admin'?"Consulter les Projets en cours "."(".count($data).")":"Confirmer les achievement de travail"}}</h4>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" style="height: 60px;weight: 208px;">
                                            <a href="/home/projet/{{$item->id}}/edit" ><button class="btn btn-primary" style="height: 40px;weight: 40px;" ><i class="fa fa-edit"></i></button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
