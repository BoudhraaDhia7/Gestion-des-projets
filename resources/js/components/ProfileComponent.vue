...
<div class="row">
    <div class="col-12">
        <div class="alert alert-primary" v-if="message">
            ...
            Les détails du profil ont été mis à jour avec succès!
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input v-bind:class="{'is-invalid': errors.password}" type="password" v-model="password" class="form-control" autocomplete="new-password" placeholder="Nouveau mot de passe (uniquement si vous souhaitez modifier le mot de passe)">
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Confirmez le mot de passe</label>
                    <div class="col-sm-12 col-md-7">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <button v-bind:disabled="loading" @click="updateUser" class="btn btn-primary"><span v-if="loading">Mise à jour</span><span v-else>Mettre à jour</span></button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        updateUser() {
            ...
            _this.message = '';
            _this.loading = true;
            axios.post(this.$parent.MakeUrl('admin/users/'+this.getUserdata('id')), {'name': this.name, 'email': this.email,  'role': this.role, 'password': this.password, 'password_confirmation': this.password_confirmation, '_method': 'PATCH'}).then((res) => {
